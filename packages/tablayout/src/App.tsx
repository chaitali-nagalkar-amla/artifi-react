  ...
  return (
    <div className="m-3 w-[35%]">
      ...
      <div className='flex my-1'>
        ...
        <HorizontalAlignment value={"center"} onChange={() => { }} />
        <VerticalAlignment value={"top"} onChange={() => { }} />
        <DeleteText isActive={true} />
      </div>
      <ColorSwatches value={'#ffffff'} onChange={() => { }} />
      <FontFamily value={"Open Sans"} onChange={() => { }} />
      <FontSize value={'20'} onChange={() => { }} /> */}
      {/* <TextList dataArray={[]}></TextList>
     <ImageList dataArray={undefined}></ImageList>





      {/* <UserImages searchRequired={false}></UserImages> */}
      {/* <Clipart/>  */}
      {/* <FontSize value={'20'} onChange={() => { }} />
      <Upload />
      <UserImages searchRequired={false}></UserImages>
