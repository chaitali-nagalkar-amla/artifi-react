...
export const UPLOAD_IMAGE_SETTING_API_PATH = generateURL("api/v1/UploadImage/GetImageSettings");
export const UPLOAD_IMAGE_API_PATH = generateURL("api/v1/UploadImage/UploadImage");
